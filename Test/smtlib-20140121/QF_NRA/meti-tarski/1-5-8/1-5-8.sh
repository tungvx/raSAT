directory=s1310007@hpcc:/work/tungvx/raSAT_2_1TCs_10_1DecomposedVar_19/QF_NRA/meti-tarski
strategy=1-5-8
sshpass -p 'toilatung90!2' scp $directory/Arthan/1-5-8-20150422-Arthan.csv $strategy-20150422-Arthan.csv
sshpass -p 'toilatung90!2' scp $directory/asin/1-5-8-20150430-asin.csv $strategy-20150430-asin.csv
sshpass -p 'toilatung90!2' scp $directory/atan/problem/1-5-8-20150430-atan.problem.csv $strategy-20150430-atan.problem.csv
