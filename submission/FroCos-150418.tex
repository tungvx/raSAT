...
\hline
    ...
    & \multicolumn{2}{|c}{UNSAT} & \multicolumn{2}{|c}{SAT} & \multicolumn{2}{|c}{UNSAT} & \multicolumn{2}{|c}{SAT} & \multicolumn{2}{|c|}{UNSAT}\\
\hline
...
\end{tabular}
\caption{Experiments on Equalities} \label{tab:equations}
\end{center}
\end{table}
