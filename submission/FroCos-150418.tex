...
\hline
    ...
    \multicolumn{4}{c|}{Zankl(151)} & \multicolumn{4}{c|}{Meti-tarski (5101)} & \multicolumn{4}{c|}{Keymaera} \\
\hline
    & \multicolumn{2}{c|}{SAT} & \multicolumn{2}{c}{UNSAT} & \multicolumn{2}{|c|}{SAT} 
    & \multicolumn{2}{c|}{UNSAT} & \multicolumn{2}{c}{SAT} & \multicolumn{2}{|c|}{UNSAT} \\
\hline
 \bf raSAT \cite{VanKhanh201227} & 21 & 933.39(s)& 10 & 0.38 (s)
 &  &  &  & &  &  &  &  \\
\hline
\bf current raSAT & 36 & 1675.76 (s) & 10 & 0.91 (s) &  &  &  &  &  & &  &  \\
\hline 
\bf iSAT3 & 14 & 201.08(s) & 19 & 8.17(s) &  &  &  &  & 0 & 0(s) & 
310 & 103.22(s) \\
\hline
\bf dREAL &  &  &  &  &  & &  &  &  &  & 
 &  \\
