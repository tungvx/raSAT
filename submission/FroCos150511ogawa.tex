...
Here, (10)-(7)-(9) means all random selection. 
...
Current {\bf raSAT} implementation on equations has only naive strategies. 
...
Preliminary experiments on handling equations from QF\_NRA/Zankl and QF\_NRA/Meti-tarski
are summmarized in Table~\ref{tab:equations}.
