...
def solve(args):
  ...
  startTime = time.time()
  try: 
    proc = subprocess.Popen(["./rat1_linux64", os.path.join(root, filename)],stdout=subprocess.PIPE,universal_newlines = True)
...
run("QF_NRA/hong", 10, "smt-rat.csv", 320, BOUNDED_SMT2)
