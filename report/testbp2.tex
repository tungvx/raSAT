...
Two more examples:
\begin{center}
\AXC{$x_1+2x_2-3>0$} \AXC{$2(x_1-x_2)>0$} \BIC{$x_1-1 > 0$}
\AXC{$4x_1+x_3<0$} \AXC{$x_1-x_3<0$} \BIC{$-x_1>0$}
\BIC{$-1>0$}
\DP
Proof of conflict
\end{center}
...
\begin{center}
\AXC{$x_1+2x_2-3>0$} \AXC{$2(x_1-x_2)>0$} \BIC{$x_1-1 > 0$}
\AXC{$0 \le 0$} \AXC{$0 \le 0$} \BIC{$0 \ge 0$}
\BIC{$x_1-1 > 0$}
\DP \\
...
\begin{center}
\AXC{$\neg(x_1+2x_2-3>0) \lor \neg(x_1-x_2>0) \lor \neg(4x_1+x_3<0)\lor \neg(x_1-x_3<0) \lor a$} \AXC{$x_1+2x_2-3>0 \lor a$} \BIC{$\neg(x_1-x_2>0) \lor \neg(4x_1+x_3<0)\lor \neg(x_1-x_3<0) \lor a$}
\AXC{$x_1-x_2>0 \lor b$}  \BIC{$ \lor \neg(4x_1+x_3<0)\lor \neg(x_1-x_3<0) \lor a \lor b$}
\DP
