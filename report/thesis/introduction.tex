...
that satisfies given polynomial inequalities/equations. If such an assignment exists, the constraint is said to be satisfiable (SAT); otherwise we mention it as unsatisfiable (UNSAT). 
