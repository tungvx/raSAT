...
\begin{theorem}
Let $\Pi = \bigwedge\limits_{v_i \in V} v_i \in i_i$ where $i \in \mathbb{I}$ and $i$ is bounded; and $\varphi = \bigwedge\limits_{j = 1}^n f_j > 0$. Denote $S_j = \{(x_1, x_2, \cdots) | \theta = \{v_i \mapsto x_i | v_i \in V \}; \models_{\theta^I} \Pi \text{ and } \models_{\theta^p_\mathbb{R}}f_j \}$
\end{theorem}
